...
importancies_elasticnet_grade1 <- importancies_elasticnet_grade1 %>%
  filter(Coef != 0)  # Filtra els resultats que són zero
importancies_elasticnet_grade2 <- importancies_elasticnet_grade2 %>%
  filter(Coef != 0)  # Filtra els resultats que són zero
importancies_elasticnet_grade3 <- importancies_elasticnet_grade3 %>%
  filter(Coef != 0)  # Filtra els resultats que són zero
